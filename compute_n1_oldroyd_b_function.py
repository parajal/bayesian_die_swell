...
def compute_n1_oldroyd_b(
    ...
    """Compute N1 = tau_xx - tau_yy for the Oldroyd-B model.

    You can provide either rates directly, or provide U_avg and radius/diameter
