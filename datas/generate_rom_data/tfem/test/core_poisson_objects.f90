...
!    ( mesh, ipd, degfd=(/1/), curve1=3, curve2=4 )
  ...
  call define_constraint ( mesh, ipd, object=1, discretization='collocation', &
    nodedof=1 )
  call define_constraint ( mesh, ipd, object=2, discretization='collocation', &
    nodedof=1 )
...
!  close(unit=10)
  ...
  call fill_sample ( mesh, problem, sample, ndegfd=1, object=3, &
    elemsub=sample_node )
