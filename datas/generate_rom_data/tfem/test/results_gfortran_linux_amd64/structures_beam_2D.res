...
Problem info:
 ...
 reaction forces     reaction moments    maxval abs(sysvector)   2.3843989011266067     
 maxval abs(sol)   2.1054426394824386     
 distributed forcemaxval abs(dvec)   1.0000000000000000     
 transverse displacementmaxval abs(dvec)   1.4990198840275359     
 slopemaxval abs(dvec)   2.1054426394824386     
 second derivativemaxval abs(dvec)   2.3852322344599379     
 bending momentmaxval abs(dvec)   2.3852322344599379     
 shear forcemaxval abs(dvec)   1.1745791899586493     
 axial displacementmaxval abs(dvec)   1.0068313313544910     
 axial strainmaxval abs(dvec)   1.0068313313544923     
 axial forcemaxval abs(dvec)   1.0068313313544923     
