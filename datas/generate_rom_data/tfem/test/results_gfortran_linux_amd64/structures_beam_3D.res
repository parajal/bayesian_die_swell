...
Problem info:
 ...
 reaction forces     reaction moments    maxval abs(sysvector)   10.713755106700205     
 maxval abs(sol)   2.5847358881970495     
 distributed forcemaxval abs(dvec)   0.0000000000000000     
 transverse displacement vmaxval abs(dvec)   1.6681963542380978     
 slope v'maxval abs(dvec)   2.3314516580758777     
 second derivative v''maxval abs(dvec)   3.2526553631729564     
 bending moment Mzmaxval abs(dvec)   3.2526553631729564     
 shear force Vmaxval abs(dvec)   1.8424074101976657     
 axial displacementmaxval abs(dvec)   1.0399261289773447     
 axial strainmaxval abs(dvec)   1.0399261289773474     
 axial forcemaxval abs(dvec)   1.0399261289773474     
 axial (torsional) rotation thetamaxval abs(dvec)   3.1939639795713037     
 torsional strain dtheta/dsmaxval abs(dvec)   2.5847358881970530     
 torsional moment Mxmaxval abs(dvec)   2.5847358881970530     
 transverse displacement wmaxval abs(dvec)  0.96233061597741032     
 slope w'maxval abs(dvec)   1.9322112894438312     
 second derivative w''maxval abs(dvec)   4.1141467433348442     
 bending moment Mymaxval abs(dvec)   8.2282934866696884     
 shear force Wmaxval abs(dvec)   10.713755106703729     
