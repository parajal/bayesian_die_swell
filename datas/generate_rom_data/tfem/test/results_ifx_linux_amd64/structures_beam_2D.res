...
Problem info:
 ...
 reaction forces     reaction moments    maxval abs(sysvector)
   2.38439890112661     
 maxval abs(sol)   2.10544263948244     
 distributed forcemaxval abs(dvec)   1.00000000000000     
 transverse displacementmaxval abs(dvec)   1.49901988402754     
 slopemaxval abs(dvec)   2.10544263948244     
 second derivativemaxval abs(dvec)   2.38523223445994     
 bending momentmaxval abs(dvec)   2.38523223445994     
 shear forcemaxval abs(dvec)   1.17457918995865     
 axial displacementmaxval abs(dvec)   1.00683133135449     
 axial strainmaxval abs(dvec)   1.00683133135449     
 axial forcemaxval abs(dvec)   1.00683133135449     
