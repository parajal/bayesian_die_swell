...
Problem info:
 ...
 reaction forces     reaction moments    maxval abs(sysvector)   10.713755106693823     
 ...
 second derivative v''maxval abs(dvec)   3.2526553631741311     
 bending moment Mzmaxval abs(dvec)   3.2526553631741311     
 shear force Vmaxval abs(dvec)   1.8424074101968637     
 axial displacementmaxval abs(dvec)   1.0399261289767354     
 axial strainmaxval abs(dvec)   1.0399261289767372     
 axial forcemaxval abs(dvec)   1.0399261289767372     
 axial (torsional) rotation thetamaxval abs(dvec)   3.1939639795700336     
 torsional strain dtheta/dsmaxval abs(dvec)   2.5847358881968039     
 torsional moment Mxmaxval abs(dvec)   2.5847358881968039     
 transverse displacement wmaxval abs(dvec)  0.96233061597640190     
 slope w'maxval abs(dvec)   1.9322112894422858     
 second derivative w''maxval abs(dvec)   4.1141467433355263     
 bending moment Mymaxval abs(dvec)   8.2282934866710526     
 shear force Wmaxval abs(dvec)   10.713755106701285     
