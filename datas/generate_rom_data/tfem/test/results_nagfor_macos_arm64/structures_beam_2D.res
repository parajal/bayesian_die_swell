...
Problem info:
 ...
 reaction forces     reaction moments    maxval abs(sysvector)   2.3843989011313163
 maxval abs(sol)   2.1054426394836283
 distributed forcemaxval abs(dvec)   1.0000000000000000
 transverse displacementmaxval abs(dvec)   1.4990198840281406
 slopemaxval abs(dvec)   2.1054426394836283
 second derivativemaxval abs(dvec)   2.3852322344646466
 bending momentmaxval abs(dvec)   2.3852322344646466
 shear forcemaxval abs(dvec)   1.1745791899635807
 axial displacementmaxval abs(dvec)   1.0068313313542225
 axial strainmaxval abs(dvec)   1.0068313313542241
 axial forcemaxval abs(dvec)   1.0068313313542241
