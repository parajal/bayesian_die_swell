...
contains
  ...
  function cfunc ( nr, xr )
    ...
    select case(nr)
      case(1)
        cfunc = R * [ -cos(pi*xr/2-pi/4), sin(pi*xr/2-pi/4) ]
      case default
...
!  namelist /meshpar/ elshape, R, H, n1, n2, f1
...
!  call plot_mesh ( plot_options, mesh, 'mesh.fig' )
  ...
  call write_mesh ( mesh, 'mesh_cyl_in_box.out' )

  call printinfo ( mesh )

  call delete ( mesh )

end program mesh_cylinder_in_box
