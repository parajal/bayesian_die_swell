...
! NOTE: this is similar to sphere22, but now using an evp model.
...
! constants
  ...
  integer, parameter :: &
    ...
    alam_model = 1    ! 0:none, 1:elastic, 2: Saramito1, 3: Saramito2
...
! variables
  ...
  real(dp) :: &
    ...
    eta_p = 20.0_dp,    & ! polymer viscosity
...
!    lambda, tau_y, K, n, deltat, beta, rs_gup, is_gup, rs_c, is_c, U, restart
