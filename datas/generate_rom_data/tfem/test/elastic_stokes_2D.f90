...
! displacement during the iteration within a time step (full solution vector)
  type(sysvector_t), pointer :: dispiter
...
! variables
  ...
  integer :: &
    ...
    nx_f = 10,          & ! number of elements of fluid domain x-direction
    ny_f = 3,          & ! number of elements of fluid domain y-direction
    nx_s = 3,           & ! number of elements of solid domain x-direction
    ny_s = 2,           & ! number of elements of solid domain y-direction
...
! fill fluid coefficients
  ...
  call create_coefficients ( coefficients_f, ncoefi=150, ncoefr=100 )
...
! create system vectors (solution and right-hand side)
  ...
  dispiter => soln ! used in constraint (pointer)
...
! delete all data including all allocated memory
  ...
  call delete ( velo, disp, pres, dispobject )
  call delete ( disp_vec )
