...
! Post-processing for extrudate_swell3 (axisymmetric viscoelastic)
...
! print data on curve to a file
  ...
  call printtofile ( mesh, problemc, 'czz_curve1.out', curve=1, vector=czz )
  call printtofile ( mesh, problemc, 'czz_curve2.out', curve=2, vector=czz )
  call printtofile ( mesh, problemc, 'czr_curve1.out', curve=1, vector=czr )
  call printtofile ( mesh, problemc, 'czr_curve2.out', curve=2, vector=czr )
  call printtofile ( mesh, problemc, 'crr_curve1.out', curve=1, vector=crr )
  call printtofile ( mesh, problemc, 'crr_curve2.out', curve=2, vector=crr )
  call printtofile ( mesh, problemc, 'ctt_curve1.out', curve=1, vector=ctt )
  call printtofile ( mesh, problemc, 'ctt_curve2.out', curve=2, vector=ctt )
