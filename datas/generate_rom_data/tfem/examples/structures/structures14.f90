...
! (interim exam on 23-09-2015 of course Mechanics 4RA00).

program structures14
...
! build (assemble) matrix and vector from elements
  ...
  call build_system ( mesh, problem, sysmatrix, rhsd, elemsub=truss_elem1, &
    order='ND', mcoefficients=coefficients, buildvector=.false. )
...
! post processing
  ...
  call postprocessing_truss ( mesh, problem, mcoefficients=coefficients, &
    mshfilename='structures14.mso', sol=sol, load=load, reacf=reacf )
