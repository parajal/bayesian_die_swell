! A simple 2D truss problem (based on an example in the course Mechanics 4RA00).
...
! post processing
  ...
  call postprocessing_truss ( mesh, problem, coefficients=coefficients, &
    mshfilename='structures1.mso', sol=sol, load=load, reacf=reacf )
