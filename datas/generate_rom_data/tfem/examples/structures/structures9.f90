...
! P1/P3 interpolation.
! Identical to structures8, except using 2D elements instead of 1D elements.
...
! post processing
  ...
  call postprocessing_beam2 ( mesh, problem, mcoefficients=coefficients, &
    mshfilename='structures9.mso', sol=sol, load=load, reacf=reacf )
