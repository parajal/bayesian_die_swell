...
! variables
  ...
  logical :: monitor_vorticity=.true.
  integer :: icomp, step, i, npar, ios
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ restart, ly, timeint, numtimesteps, logc, &
    model, eta_s, eta_p, lambda, alphapar, deltat, beta, U, &
    rs_gup, is_gup, rs_c, is_c, monitor_vorticity
...
!   write monitor data
    ...
    if ( monitor_vorticity ) then
      ...
      write(unit=14,fmt=*) &
        step, step*deltat, maxval(abs(vorticity%u))
