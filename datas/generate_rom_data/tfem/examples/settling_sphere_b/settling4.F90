...
! This a problem similar to settling2, but now it uses pardiso as solver
...
! store solution vectors and problem structures
  ...
  solver_options_pardiso%printlevel = 0
...
!     solve
      ...
      call solve_system_pardiso ( sysmatrix, rhsd, dsol, &
