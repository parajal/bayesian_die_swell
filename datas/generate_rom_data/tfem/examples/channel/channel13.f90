...
! definitions
  ...
  type(vector_t) :: pressure, ctensor
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ timeint, numtimesteps, logc, &
...
! write to a vtk file for further post-processing
  ...
  call write_scalar_vtk ( mesh, problem, vector=pressure, dataname='pressure', &
    filename='channel13.vtk' )

  call write_vector_vtk ( mesh, problem, filename='channel13.vtk', &
    dataname='velocity_vector', sysvector=sol, physq=physqvel, append=.true. )

  call write_tensor_vtk ( mesh, problemc, filename='channel13.vtk', &
