...
! Similar to startup60, but now using the b-formulation
...
!   constant part of right-hand side
    ...
    call rhs_3D_b ( vemoptn, vemopt_gammapn )
...
!     right-hand side and Jacobian for all modes at once
      ...
      call rhs_3D_b ( vemopt, vemopt_gammap )
...
! build rhs for given vemopt
  ...
  subroutine rhs_3D_b ( vemopt, vemopt_gammap )
...
!   plastic strain
    call rhs_plastic_strain_3D_b ( vemodel, b, gammap, rhs_gammap, &
      mode1=1, mode2=am, vemopt_gammap=vemopt_gammap )

  end subroutine rhs_3D_b

end program startup61
