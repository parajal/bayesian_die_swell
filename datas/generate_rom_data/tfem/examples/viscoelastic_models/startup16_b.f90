...
! 2D axisymmetric flow. Combined shear and uniaxial extensional flow.
...
program startup16_b
  ...
  integer, parameter :: model    = 2, &  ! 2: Oldroyd model 3: Giesekus
                        ...
                        ncompb   = 5, &  ! number of components of 5
...
! initialize velocity gradient
  ...
  L = [ epsilondot, gammadot, 0._dp, -epsilondot/2, -epsilondot/2 ]
