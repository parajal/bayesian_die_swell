...
! The model is a multi-mode Giesekus model.
...
program startup22
  ...
  integer, parameter :: nmodes  = 3,  & ! number of modes
                        model   = 3 , & ! Giesekus
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ flowtype, G, lambda, alpha, &
