...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ flowtype, includesolvent, eta_s, model, G, lambda, &
                     ...
                     factor, eps, maxnumiterations, eigen, alam_model
...
! open output files
  ...
  open ( unit=14, file='steady2.out', recl=300 )
  if ( eigen ) open ( unit=15, file='eigen2.out', recl=300 )
