...
! open output files
  ...
  open ( unit=14, file='steady10.out', recl=300 )
  if ( eigen ) open ( unit=15, file='eigen10.out', recl=300 )
  open ( unit=16, file='detc10.out', recl=300 )
