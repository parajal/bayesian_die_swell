...
! with multi-mode von Mises stress
...
! open output files
  ...
  open ( unit=14, file='steady16.out', recl=300 )
  open ( unit=16, file='detc16.out', recl=300 )
...
!   Output
    ...
    write(16,*) rate(i), (detc_2D(c(1,:,m)), m=1,nmodes)
