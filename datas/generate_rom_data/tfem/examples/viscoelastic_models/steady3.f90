...
! The model is an evp model (Saramito 2009, SRM2) with Oldroyd-B or Giesekus
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ flowtype, includesolvent, eta_s, model, G, lambda, &
                     mobility, tau_y, Kfac, nexp, numdatapoints, &
...
! open output files
  ...
  open ( unit=14, file='steady3.out', recl=300 )
  if ( eigen ) open ( unit=15, file='eigen3.out', recl=300 )
