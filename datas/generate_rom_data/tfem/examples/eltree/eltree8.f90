...
! constants
  ...
  integer, parameter :: &
    ...
    gauss_ie    = 6     ! Gauss integration rule for the interface elements

  real(dp), parameter :: &
    split_threshold = 0.1_dp, &  ! levelset value for being "close" enough
...
! read mesh
  ...
  call read_mesh_gmsh ( mesh, filename='mesh8.msh' )

  call fill_mesh_parts ( mesh )

  call write_mesh_vtk ( mesh, filename='mesh8.vtk' )
...
! analytical solutions
  ...
  print *, 'computed surface of sphere boundary = ', resultsum(1)
  ...
  print *,  ''
  print *, 'computed normal integral sphere = ', resultsum(3)
  print *, '                                  ', resultsum(4)
  print *, '                                  ', resultsum(5)
...
!   plot the interface mesh (double nodes removed)
    ...
    call write_mesh_vtk ( mesh2, filename='imesh8.vtk' )
...
!   plot the eltrees
    ...
    call write_mesh_vtk ( mesh_plot, filename='mesh_eltree8.vtk' )
    call delete(mesh_plot)
