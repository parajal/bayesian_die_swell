! Startup + steady state of flow around a cylinder for a b-representation
! of an incompressible ! EGP model.
...
! definitions
  ...
  real(dp) :: alpha, epsu, epsp, epsb, Wi, K_drag
...
! time stepping
  ...
  do step = 1, numtimesteps + 1  ! one extra step for steady-state
