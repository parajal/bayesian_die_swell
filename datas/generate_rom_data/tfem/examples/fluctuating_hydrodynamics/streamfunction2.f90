...
! read mesh
  ...
  call add_to_mesh ( mesh, curve=[1,2,3,4] )  ! full boundary
...
! build (assemble) matrix and vector from elements
  ...
  call plot_color_contour ( plot_options, mesh, problem, 'streamfunction2.fig',&
    sysvector=sol )
