...
! Fictitious domain method with a rigid-ring description.
...
! create mesh for particle boundary
  ...
  xpc = [0._dp,0._dp] ! initial position of the center of the particle
...
!   change elshape to 34 for isoparametric mapping
  ...
  call write_mesh ( mesh, 'mesh2.out' )

  call plot_points_curves ( plot_options, mesh, 'curves.fig' )
  call plot_mesh ( plot_options, mesh, 'mesh2.fig' )
  plot_options%objectpointcolor=4
  plot_options%objectpointsize=0.4
  call plot_objects ( plot_options, mesh, 'mesh2.fig', append=.true. )
