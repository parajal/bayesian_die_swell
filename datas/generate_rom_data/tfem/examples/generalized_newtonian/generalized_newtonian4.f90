! Generalized Newtonian problem with yield on a unit square.
! Periodical boundary conditions.
! Poiseuille flow. Collocation of nodes.
! Similar to generalized_newtonian3 but now using a Newton-Raphson iteration
! preceded by a number of Picard iterations.

program generalized_newtonian4
...
! constants
  ...
  integer, parameter :: &
    ...
    nPicard=50,         & ! number of Picard iterations before Newton-Raphson
  ...
  real(dp), parameter :: &
    ...
    epspd = 1.e-10,  & ! maximum pressure difference for iteration
    flowrate = 2._dp
...
end program generalized_newtonian4
