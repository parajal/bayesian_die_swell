...
! Picard iteration.
! Similar to the generalized_stokes4 example, but now using the
! generalized newtonian elements instead of the generalized stokes elements.

program generalized_newtonian3
...
! fill coefficients
  ...
  coefficients%i(253) = 0  ! Picard iteration
...
end program generalized_newtonian3
