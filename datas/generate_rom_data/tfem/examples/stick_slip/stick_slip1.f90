...
! 1) An entry problem with a parabolic velocity profile and zero stress.
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ timeint, numtimesteps, logc, eta_s, eta_p, &
    ...
    rs_gup, is_gup, rs_c, is_c, U_avg, restart
...
! fill solution vector with essential boundary conditions
  ...
  call fill_sysvector ( mesh, problem, sol, &
    curve1=4, physq=2, degfd=1, func=uprofile, funcnr=1  )
