! Grid deformation: the elements are "attracted" towards a circle.
! Periodical boundary conditions in x-direction

program grid_deformation3

  use kind_defs_m
  use tfem_m
  use meshgen_grid_deformation_m
  use deform_mesh_ma57_m
  use subs_grid_deformation3_m
  use figplot_m
  use timer_m
...
!   away from the the zero levelset (max_f).
    ...
    center(2)=[0.15_dp,0._dp]  ! center of the circle
