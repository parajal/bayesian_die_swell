...
! Bilinear Q1 elements for the displacement.

program linear_elastic9
...
! post processing
  ...
  call postprocessing_linear_elastic ( mesh, problem, 'le9.vtk', sol, &
