...
! problem definition
  ...
  if ( uniform ) then
    call define_essential ( mesh, input_probdef, surfaces=[5], physq=1, &
      degfd=[1,0,0] )
...
! post processing
  ...
  call postprocessing_linear_elastic ( mesh, problem, 'le25.vtk', sol, &
