...
! constants
  ...
  real(dp), parameter :: &
    ...
    or = 1._dp,  &      ! start of domain in r-direction
...
! post processing
  ...
  call postprocessing_linear_elastic ( mesh, problem, 'le18.vtk', sol, &
