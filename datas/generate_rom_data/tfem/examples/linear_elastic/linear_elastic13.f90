! Linear elastic problem on a rectangle. Manufactured solution.
! Mixed displacement-pressure formulation. 2D, plane strain or plane stress.

program linear_elastic13
...
! constants
  ...
  real(dp), parameter :: &
    lx = 1._dp,  &  ! length of domain in x-direction
    ly = 1._dp,  &   ! length of domain in y-direction
...
! post processing
  ...
  call postprocessing_linear_elastic ( mesh, problem, 'le13.vtk', sol, &
