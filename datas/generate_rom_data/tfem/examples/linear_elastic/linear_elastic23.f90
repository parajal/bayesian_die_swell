...
! Standard displacement formulation. Axisymmetric.

program linear_elastic23
...
! post-processing
  ...
  call postprocessing_linear_elastic ( mesh, problem, 'le23.vtk', sol, &
