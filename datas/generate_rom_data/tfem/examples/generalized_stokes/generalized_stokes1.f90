...
! Varying visosity eta using a function.

program generalized_stokes1
...
! fill coefficients
  ...
  coefficients%i(251) = 1  ! compute eta using a function routine
  coefficients%i(252) = funcnr_eta

  coefficients%func1(1)%p => etafunc   ! scalar function for the viscosity
...
end program generalized_stokes1
