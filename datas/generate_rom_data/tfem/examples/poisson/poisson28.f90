...
! constants
  ...
  integer, parameter :: &
    uintpl = 16,        & ! scalar interpolation
    gauss = 6,          & ! 6-point triangle
    gauss2 = 3,         & ! 2-point line in height
...
! read mesh
  ...
  call read_mesh_gmsh ( mesh, filename='cube2.msh' )
...
! plot solution
  ...
  call write_scalar_vtk ( mesh, problem, filename='sol28.vtk', &
