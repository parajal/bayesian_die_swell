...
! constants
  ...
  integer, parameter :: &
    uintpl = 15,        & ! scalar interpolation
    gauss = 6,          & ! 6-point triangle
    gauss2 = 2,         & ! 2-point line in height
    gaussb = 2,         & ! 3x3 point integration of boundary elements
...
! read mesh
  ...
  call read_mesh_gmsh ( mesh, filename='cube1.msh' )
...
! plot solution
  ...
  call write_scalar_vtk ( mesh, problem, filename='sol27.vtk', &
