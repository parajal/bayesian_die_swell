...
! fill solution vector with essential boundary conditions
  ...
  call fill_sysvector ( mesh, problem, sol, &
    curve1=2, curve2=4, func=func, funcnr=14 )
...
! build (assemble) matrix and vector from elements
  ...
  coefficients%i(6) = 1  ! use a function for h_N
  coefficients%i(15) = 15  ! funcnr for flux on curve 1

  call add_boundary_elements ( mesh, problem, rhsd, curve=1, &
...
! create exact solution
  ...
  call fill_sysvector ( mesh, problem, solexact, &
    node1=1, node2=mesh%nnodes, func=func, funcnr=14 )
