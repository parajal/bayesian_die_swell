...
! Iterative solver CG with diagonal (Jacobi) preconditioner using a fixed
...
! definitions
  ...
  type(solver_options_diag_t) :: solver_options
...
! build (assemble) matrix and vector from elements
  ...
  call set_solver_options ( solver_options, printlevel=2, itsolver=1, &
    fixednumiterations=10 )

  call solve_system_diag ( sysmatrix, rhsd, sol, solver_options=solver_options )
