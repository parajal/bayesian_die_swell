...
! triangular elements
!
! This is the sphere9 problem with the following changes:
!  1) P1isoP2 shape functions
!  2) subdomain Gauss integration (using 4 subtriangles)
...
! constants
  ...
  integer, parameter :: &
    ...
    gauss = 3,      & ! 3 point Gauss on triangle
    gaussb = 2,     & ! 2 point Gauss on curves
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ timeint, numtimesteps, logc, eta_s, eta_p, &
    ...
    rs_gup, is_gup, rs_c, is_c, U, restart
