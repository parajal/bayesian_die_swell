...
! definitions
  ...
  type(solver_options_mkl_t) :: solver_options
...
! set parameters for iterative solver
  ...
  call set_solver_options ( solver_options, printlevel=2, maxmvm=150, &
    preconditioner=2, fillin=2.0_dp, droptol=1.e-3_dp, &
    eps_rel=1.e-6_dp, eps_abs=1.e-6_dp, zero_diag_par=0, &
    zero_diag_comp=1.e-3_dp, zero_diag_value=1.e-3_dp )

  call solve_system_mkl_gmres ( sysmatrix, rhsd, sol, &
