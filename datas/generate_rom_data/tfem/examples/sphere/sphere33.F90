...
! definitions
  ...
  type(lu_umfpack_t) :: luc
  type(solver_options_umfpack_t) :: solver_options_u, solver_options_c
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ timeint, numtimesteps, logc, eta_s, eta_p, &
    lambda, deltat, beta, rs_gup, is_gup, rs_c, is_c, U, restart
...
!   solve gradient/velocity/pressure problem
    ...
    call solve_system_umfpack ( sysmatrix, rhsd, sol, &
...
!   solve conformation and keep LU decomposition in the loop over components
    ...
    do icomp = 1, ncompc
      call solve_system_umfpack ( sysmatrixc, rhsc(icomp,1), solc(icomp,1), &
