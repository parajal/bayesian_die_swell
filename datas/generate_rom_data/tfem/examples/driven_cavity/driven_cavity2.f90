...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ nx, ny, timeint1, timeint2, numtimesteps, logc, eta_s, &
    eta_p, lambda, mobility, deltat, beta, rs_gup, is_gup, rs_c, is_c
...
! Dirichlet boundary conditions
  ...
  call define_essential ( mesh, input_probdef, curve1=1, curve2=4, physq=2 )
...
! set velocity = 0 on boundaries
  call fill_sysvector ( mesh, problem, soln, &
    curve1=1, curve2=4, physq=2, value=0._dp )
! set velocity_x = 1 on upper boundary
  call fill_sysvector ( mesh, problem, soln, &
    curve1=3, physq=2, degfd=1, exclude=3, value=1._dp )
...
! extract initial velocity for plotting
  ...
  call extract_physvector ( mesh, problem, soln, velocity0 )
