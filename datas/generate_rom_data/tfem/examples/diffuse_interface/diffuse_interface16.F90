...
! This problem is similar to diffuse_interface15, but now with
! pardiso as the solver


program diffuse_interface16
...
! definitions for DI and up problems
  ...
  type(lu_pardiso_t) :: lu_u_pardiso
...
! variables
  ...
  real(dp) :: cmax, cdiff, phi_di, c_B, surf_ten
...
!   solve up system
    ...
    call solve_system_pardiso ( sysmatrix, rhsd, sol_np1, lu=lu_u_pardiso, &
...
!     solve (c,mu)
      ...
      call solve_system_pardiso ( sysmatrixdi, rhsdi, soldi_np1, &
        solver_options=solver_options_pardiso )
...
!   solve (c,mu)
    ...
    call solve_system_pardiso ( sysmatrixdi_init, rhsdi_init, soldi_init, &
      solver_options=solver_options_pardiso )
...
!   solve the projection problem
    do i = 1, ncompv_P2
      ...
      call solve_system_pardiso ( sysmatrix_proj, rhsd_proj(i), sol_proj(i), &
        lu=lu_pardiso, solver_options=solver_options_pardiso )
    end do
...
end program diffuse_interface16
