! 2D generalized Stokes problem on a square domain with a cylinder
...
! functions module for xfem11

module functions_xf11_m
...
! definitions
  ...
  integer :: i, elem, nelem, nnodes, plotobj, nbx, nby, iter
  real(dp) :: vd, pd
...
! create system vectors (solution and right-hand side)
  ...
  sol%u = 0 ; soln%u = 0 ! initialize old solution to zero
