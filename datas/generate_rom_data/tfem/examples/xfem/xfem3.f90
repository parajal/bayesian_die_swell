...
! functions module for xfem3

module functions_xf3_m
...
! object for plotting the nodeset
  ...
  call plot_mesh ( plot_options, mesh, 'mesh_xf3.fig' )
  plot_options%objectpointcolor=4
  plot_options%objectpointsize=0.4
  call plot_objects ( plot_options, mesh, 'mesh_xf3.fig', append=.true., &
    object1=1 )
...
!   post-processing: plot in a layer
    ...
    call plot_in_layer ( 'velocity_xf3_layer.fig', &
      'pressure_contour_xf3_layer.fig', &
      'vorticity_contour_xf3_layer.fig', layer=1 )
