...
! eXtended FEM approach with embedded Baumann-Oden condition on the cylinder.
...
! Similar to xfem8 but now with Baumann-Oden approach

! functions module for xfem10

module functions_xf10_m
...
! constants
  ...
  real(dp), parameter :: &
    ...
    U(2) = [ 1._dp, 2._dp ], & ! imposed velocity of the cylinder
                                 ! if coefficients%i(42) = 0
...
! build (assemble) matrix and vector from elements
  ...
  coefficients%i(45) = 0  ! sign of the transposed pressure term (0=absent)
