...
! NOTE: This is similar to couette2, but now using the b-formulation with
!       implicit b-tensor.
...
! variables
  ...
  real(dp) :: &
    ...
    is_b  = 1.4_dp       ! integer_storage for the b-tensor LU (HSL)
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ printscreen, nx, ny, timeint1, timeint2, &
    numtimesteps, maxnumiterations, dist_step, thetapar, epsconf, &
