...
!
! This is the couette1 problem with the following changes:
!  1) triangular elements
!  2) P1isoP2 shape functions
!  3) subdomain Gauss integration (using 4 subdomains/subtriangles)
...
! constants
  ...
  integer, parameter :: &
    ...
    gauss = 3,      & ! 3 point integration of the sub triangle
    gaussb = 2,     & ! 2 point integration of the sub linear element
...
! initialize vectors steady stress and a small random perturbation.
