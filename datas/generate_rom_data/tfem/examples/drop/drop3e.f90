...
! Variables
  ...
  integer ::  &
    ...
    n=4,                 & ! number of elements in x and y direction of box
    nc=30,               & ! number of elements on the circle
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ solid, periodic, flowrate, move_mesh_x, mesh_plot,&
    compute_error, compute_volume, n, nc, model, gauss, gaussb, choice_um, &
    vfuncnr, vtkevery, ctime, restart, restart_every, &
    logc, timeint1, timeint2, timeint, numtimesteps, &
    ox, oy, lx, ly, xc, rc, eta_e, eta_i, eta_p, lambda_p, G_s, &
...
!   Surface tension
    ...
    call add_boundary_elements ( mesh, problem, rhsd, &
      elemsub=surface_tension_curve, curve=5, coefficients=coefficients(1), &
      physq=[physqvel] )
