...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ periodic, flowrate, move_mesh_x, mesh_plot, &
    ...
    ox, oy, lx, ly, xc, rc, eta_e, eta_i, gammac, factor, U_avg, &
    rs_up, is_up, deltat
...
!     update the nodes of the mesh
      ...
      call update_mesh_nodes_from_displacement ( order=3 )
...
!     update the nodes of the mesh
      ...
      call update_mesh_nodes_from_displacement ( order=4 )
