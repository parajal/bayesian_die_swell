...
! some more misc variables
  ...
  integer :: nnodes, nelem, elshape, c_cpl, c_perx, c_pery, c_perz, c_flr
  integer :: vertices(4)=[1,3,5,10], post, step
...
! namelist for input of variables; read from standard input
  ...
  namelist /comppar/ periodic, triperiodic, periodic_channel, flowrate, &
    ...
    gammac, factor, U_avg, shear_rate, rs_up, is_up, deltat, beta, &
