! streamfunction problem for extrudate_swell

! Dirichlet in a single point (P4) psi=0
...
! problem definition stream function
  ...
  call define_essential ( mesh, input_probdef, point=4 ) ! Dirichlet in P4
...
! fill solution vector with essential boundary conditions
  ...
  call fill_sysvector ( mesh, problem, sol, point=4, value=0._dp )
...
! build (assemble) matrix and vector from elements
  ...
  call add_boundary_elements ( mesh, problem, rhsd, curve=mesh%ncurves, &
