...
! Optionally include surface tension (using a curve).
! Planar or axisymmetrical flow

program extrudate_swell6
...
! variables
  ...
  integer :: step, i, j, nnodes, obj_ob, obj_sh
...
!     build surface integral
      ...
      call add_boundary_elements ( mesh, problem, rhsd, &
        ...
        curve=7, coefficients=coefficients, physq=[physqvel] )
