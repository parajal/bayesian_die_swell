...
! NOTE: this problem is similar to ale5, but now with the stress-implicit method
...
! create the structure oldvectors
  ...
  call create_oldvectors ( oldvectors, nsysvec=2, nsysvec2=2, nprob=2, nvec=1 )
...
!   NOTE: meshvel will be used in the element routines to take
