...
! This problem is similar to ale12, but now in 3D
...
! variables
  ...
  real(dp) :: &
    ...
    volume_threshold = 0.1_dp,      & ! remeshing volume threshold
...
! NOTE: to visualize points and vectors in Paraview, use the "Glyph" filter
  ...
  do i = 1, mesh_np1%npoints
    write(filename,'(a,i4.4,a)') 'point_',i,'.vtk'
    call write_geometry_vtk ( mesh_np1, point=i, filename=filename )
  end do

  do i = 1, mesh_np1%ncurves
    write(filename,'(a,i4.4,a)') 'curve_',i,'.vtk'
    call write_geometry_vtk ( mesh_np1, curve=i, filename=filename )
  end do

  do i = 1, mesh_np1%nsurfaces
    write(filename,'(a,i4.4,a)') 'surface_',i,'.vtk'
    call write_geometry_vtk ( mesh_np1, surface=i, filename=filename, &
      write_normals=.true. )
  end do
