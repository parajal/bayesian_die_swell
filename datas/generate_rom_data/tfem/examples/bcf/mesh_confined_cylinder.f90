...
program mesh_confined_cylinder
  ...
  integer, parameter :: n1=8, n2=8, n3=12, n4=6

  real(dp), parameter :: f1=7, f2=6, f3=8
  real(dp), parameter :: fH=12, fdiag=15
  real(dp), parameter :: L1=15, L2=2
  real(dp), parameter :: H=2
