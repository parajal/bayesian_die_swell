...
! write to a vtk file for further post-processing
  ...
  call write_vector_vtk ( mesh, problem, filename='ns16.vtk', &
  ...
  call write_scalar_vtk ( mesh, problem, vector=gammadot, &
    filename='ns16.vtk', dataname='gammadot', append=.true. )

  call write_tensor_vtk ( mesh, problem, filename='ns16.vtk', &
