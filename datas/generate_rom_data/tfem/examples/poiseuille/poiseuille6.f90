...
! derive vectors
  ...
  call write_vector_vtk ( mesh, problem, filename='poiseuille6.vtk', &
    dataname='velocity', vector=velocity )
  call write_scalar_vtk ( mesh, problem, filename='poiseuille6.vtk', &
...
! viscous stress
  ...
  call write_tensor_vtk ( mesh, problem, filename='poiseuille6.vtk', &
