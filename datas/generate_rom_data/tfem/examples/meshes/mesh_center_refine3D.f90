...
! change orientation of surfaces of center to match with outer part
  call mesh_convert ( mesh3, mesh1, orientation=[-3,-3], surfaces=[1,4] )

  call delete ( mesh3 )

  call mesh_merge ( mesh2, mesh1, mesh, surfaces1=[12,1,7,17], &
    surfaces2=[1,6,4,2] )
...
end program mesh_center_refine3D
