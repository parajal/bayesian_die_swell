...
! Crouzeix-Raviart Q2/P1 element.
! Optionally use global shape functions for pressure.
...
! mapped (0) or global (1,2) shape functions for pressure
  integer :: global_shape = 0
...
! fill coefficients
  ...
  coefficients%i(1:11) = &
    [ uintpl,   pintpl,     0,     0,         0,  &
      ...
      gauss ]
  coefficients%i(62) = global_shape ! mapped or global shape func for pressure
...
! problem definition
  ...
  input_probdef%vec_elementdof(1)%a(14,2) = 4  ! pressure
  ...
  call define_essential ( mesh, input_probdef, element=1, elnode=14, &
    degfd=[1], physq=2 )
...
! fill solution vector with essential boundary conditions
  ...
  call fill_sysvector ( mesh, problem, sol, &
    element=1, elnode=14, degfd=1, physq=2, value=0._dp )
