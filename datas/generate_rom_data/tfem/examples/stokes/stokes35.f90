...
! Physical quantities.
! Stabilized element example: Q2/Q2 velocity/pressure
...
! constants
  ...
  integer, parameter :: &
    ...
    pintpl = 8,         & ! Q2 pressures
    pintpl1 = 4,        & ! Q1 pressure projection space
