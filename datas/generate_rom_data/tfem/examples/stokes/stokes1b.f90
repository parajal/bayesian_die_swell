...
! definitions
  ...
  type(mesh_t) :: mesh
  type(input_probdef_t) :: input_probdef, input_probdef1
...
! problem definition
  ...
  call create_input_probdef ( mesh, input_probdef1, nvec=3, nphysq=2 )
  ...
  input_probdef1%physqmask = reshape ( &
       [ .true., .true., &
  ...
  call write_input_probdef ( mesh, input_probdef1, 'pd.out' )
  call read_input_probdef ( mesh, input_probdef, 'pd.out' )
...
! build (assemble) matrix and vector from elements
  ...
  call build_system ( mesh, problem, sysmatrix, rhsd, elemsub=stokes_elem, &
    order='DN', coefficients=coefficients, usephysqmask=physqmask )
