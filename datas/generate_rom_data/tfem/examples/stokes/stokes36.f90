...
! Physical quantities.
! Stabilized element example: P1/P1 velocity/pressure
...
! constants
  ...
  integer, parameter :: &
    uintpl = 2,         & ! P1 velocities
    pintpl = 2,         & ! P1 pressures
    pintpl1 = 1,        & ! P0 pressure projection space
    physqvel = 1,       & ! physical quantity nr of the velocities
    physqpress = 2,     & ! physical quantity nr of the pressures
    gauss = 3,          & ! three point integration of triangles
    gaussp = 2,         & ! two point integration of boundary elements
...
! create mesh
  ...
  meshgen_options%elshape = 3  ! three node triangles
