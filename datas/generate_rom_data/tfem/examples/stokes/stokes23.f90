...
! 7-node triangles. Crouzeix-Raviart elements P2+/P1^d
...
!   shape function of the velocity in the collocation point
    ...
    call shape_triangle_P2plus ( xr, phi )
...
! constants
  ...
  integer, parameter :: &
    ...
    gauss = 6,          & ! 6 point integration of elements
...
! problem definition
  ...
  input_probdef%vec_elementdof(1)%a =   &
      reshape ( [2,2,2,2,2,2,2,    &  ! velocity
                 0,0,0,0,0,0,3,    &  ! pressure
                 1,1,1,1,1,1,1 ], &  ! scalar, such as vorticity
                 [7,3] )
