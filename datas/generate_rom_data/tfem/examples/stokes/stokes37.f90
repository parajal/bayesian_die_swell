...
! Stabilized element example: Q1/Q1 velocity/pressure
...
! create mesh
  ...
  meshgen_options%elshape = 5  ! 4-node quad
...
! problem definition
  ...
  input_probdef%vec_elementdof(1)%a =   &
      reshape ( [2,2,2,2,  &  ! velocity
                 1,1,1,1,  &  ! pressure
                 1,1,1,1 ], &  ! scalar, such as vorticity
                 [4,3] )
