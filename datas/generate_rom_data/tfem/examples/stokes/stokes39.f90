...
! fill coefficients
  ...
  coefficients%r(20:21) = [ 0.9_dp, 0.0_dp ] ! constant wall velocity
...
! problem definition
  ...
  call define_essential ( mesh, input_probdef, curve1=3, physq=1, degfd=[0,1] )
  call define_essential ( mesh, input_probdef, point=1, physq=2 )

  call define_constraint ( mesh, input_probdef, &
    physq=1, curve1=2, nglobalc=1 )

! curves excluding end points
  call define_constraint ( mesh, input_probdef, &
    physq=1, curve1=2, curve2=5, discretization='collocation', exclude=3 )

! end points
  call define_constraint ( mesh, input_probdef, &
    physq=1, point1=1, point2=2, discretization='collocation', nodedof=1 )

  call define_constraint ( mesh, input_probdef, &
    physq=1, point1=4, point2=3, discretization='collocation', nodedof=1 )
...
! fill solution vector with essential boundary conditions
  ...
  call fill_sysvector ( mesh, problem, sol, &
    curve1=1, physq=1, degfd=2, value=0._dp )
  call fill_sysvector ( mesh, problem, sol, &
    curve1=3, physq=1, degfd=2, value=0._dp )
  call fill_sysvector ( mesh, problem, sol, &
...
! wall slip lower wall
  call add_boundary_elements ( mesh, problem, rhsd, curve=1, physq=[physqvel], &
    sysmatrix=sysmatrix, elemsub=stokes_natboun_slip2, &
    coefficients=coefficients )

! wall slip upper wall
  call add_boundary_elements ( mesh, problem, rhsd, curve=3, physq=[physqvel], &
    sysmatrix=sysmatrix, elemsub=stokes_natboun_slip2, &
    coefficients=coefficients )
