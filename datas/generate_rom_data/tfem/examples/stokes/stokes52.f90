...
! Physical quantities.
! This is stokes1 example with Gauss integration specified by order.
...
! constants
  ...
  integer, parameter :: &
    ...
    gauss = 4,          & ! 4th-order integration (minimal) of quads
...
! fill coefficients
  ...
  coefficients%i(1:11) = &
    [ uintpl,   pintpl,     0,     0,         0,  &
      ...
      gauss ]
  coefficients%i(12:) = 0
  coefficients%i(77) = 1  ! specify polynomial order of Gauss integration
