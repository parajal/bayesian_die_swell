...
! This problem is similar to stokes1, but now with high-order elements having
...
! constants
  ...
  integer, parameter :: &
    uintpl = 20,    & ! Pp velocities
    pintpl = 20,    & ! Pp pressures
    ...
    inttype = 3,    & ! Gauss-Legendre-Lobatto for integration
...
! Set one pressure degree to zero
