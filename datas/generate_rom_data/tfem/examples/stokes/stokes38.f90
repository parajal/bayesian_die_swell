...
! Physical quantities.
! Equal order spectral elements.
! This problem is similar to stokes1, but now with spectral elements having
...
! constants
  ...
  integer, parameter :: &
    ...
    pintpl = 13,    & ! Qp pressures
    pintpl1 = 14,   & ! Pp-1 pressure projection space
