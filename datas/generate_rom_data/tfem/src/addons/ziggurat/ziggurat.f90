...
! Modified by Martien Hulsen:
!  25-01-2008: define integers to be 32-bit always, even if default integers
!              are 64-bit (e.g. with option -i8 in ifort).
!  29-03-2017: define integers constants to be 32-bit always, even if default
!              integers are 64-bit (e.g. with option -i8 in ifort).
...
MODULE ziggurat_m
   ...
   INTEGER(si),  SAVE   ::  iz, jz, jsr=123456789_si, kn(0:127),           &
                            ke(0:255), hz
