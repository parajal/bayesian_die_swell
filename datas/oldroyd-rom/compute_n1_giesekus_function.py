...
def compute_n1_giesekus(
    ...
    """Compute N1 = tau_xx - tau_yy for the Giesekus model.

    You can provide rates directly, or provide U_avg and radius/diameter
    for an axisymmetric die. You can provide beta and eta0, or G and eta_s
    directly.
    """
    if rates is None:
    ...
    vemodel = VEModel(
        model=2,      # Giesekus
        alam=0,       # standard Giesekus; 1 would be purely elastic
        lam=lam,
        G=G,
        eta_s=eta_s,
        alpha=alpha,
